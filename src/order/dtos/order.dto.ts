...
export class RedeemMilestoneOtpDto {
  @ApiProperty({
    description:
      '6-digit OTP the customer received when they paid this milestone',
  })
  @IsString()
  @IsNotEmpty()
...
export class DisputeMilestoneDto {
  @ApiProperty({
    description:
      'Why the customer is disputing this milestone. Shown to admin.',
  })
  @IsString()
  @IsNotEmpty()
...
export class ResolveMilestoneDto {
  @ApiProperty({
    ...
    description:
      'FAVOR_VENDOR releases the held transfer to the vendor; REFUND reverses the transfer and refunds the customer.',
  })
  ...
  @ApiProperty({
    required: false,
    description:
      'Admin note explaining the resolution; stored on the milestone for audit.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
