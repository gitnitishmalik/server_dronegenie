...
export class CategoryMediaController {
    ...
    async create(@Body() dto: CategoryMediaDto, @UploadedFile() file: Express.Multer.File) {
    ...
    async update(@Param('id') id: string, @Body() dto: Partial<CategoryMediaDto>, @UploadedFile() file: Express.Multer.File,) {
