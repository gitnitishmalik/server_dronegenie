import { Body, Controller, Post, Get, Param, Delete, Patch, UseInterceptors, UploadedFile, InternalServerErrorException, BadRequestException } from "@nestjs/common";
...
export class VendorDocumentController {
    ...
    @ApiResponse({ status: 200, description: 'Vendors Document Craeted successfully' })
    createDoc(@Body() dto: CreateVendorDocDto,
    ...
    @ApiResponse({ status: 200, description: 'Vendor Document updated successfully' })
