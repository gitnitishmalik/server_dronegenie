export function generateVendorHTMLTemplate(data: any, order: any): string {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="max-w-3xl mx-auto border p-6 shadow-sm">
    ...
    <div class="flex border-t border-b py-4 mb-6">
      <div class="w-1/2 pr-4">
        ...
        <p class="text-lg font-medium">${data.vendor.name}</p>
        <p class="mt-1">GST No: ${data.vendor.gstin}</p>
      </div>
