...
export class IndustryMediaController {
    ...
    async create(@Body() dto: IndustryMediaDto, @UploadedFile() file: Express.Multer.File,) {
    ...
    async update(@Param('id') id: string, @Body() dto: Partial<IndustryMediaDto>, @UploadedFile() file: Express.Multer.File,) {
