...
import { CreateIndustryDto, UpdateIndustryPropertiesDto, UpdateIndustryServicesDto } from './dtos/create-industry.dto';
...
export class IndustryController {
    ...
    async updateIndustryProperties(
        @Body() dto: UpdateIndustryPropertiesDto,
    ) {
    ...
    @ApiOperation({ summary: 'Industry Services Not Found' })
    async getServicesByIndustrySeoname(@Param('seo_name') seo_name: string, @Query() dto: PaginationDto) {
        return this.industryService.getServicesByIndustrySeoname(seo_name, dto);
    }
    ...
    @ApiOperation({ summary: 'Industry Services Not Found' })
    async getServiceIndustries(@Param('indusrtyId') indusrtyId: string, @Query() dto: PaginationDto) {
